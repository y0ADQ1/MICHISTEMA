...
class DeviceListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = DeviceCategoryAdapter(
            onViewMoreClick = { deviceCategory ->
                // Handle "Ver más" click (e.g., navigate to a detailed screen)
                // For now, we'll just finish the activity as a placeholder
                finish()
            },
            onAddDeviceClick = {
                showAddDeviceDialog()
    ...
    private fun showAddDeviceDialog() {
        ...
        val dialog = AlertDialog.Builder(this, R.style.CustomDialogTheme) // Apply custom style
